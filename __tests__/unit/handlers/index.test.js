      ...
      it(`Verify it logs notifications ${file} `, async(done) => {
        ...
        await LambdaTester( loggerHandler )
          ...
          try {
            ...
            let Item= Object.values(rec)[0]

            switch (recordType) {
              case 'bounce':
                if(isNotification){
                  expect(Item).toEqual({
                    content: "{\"bounceType\":\"Permanent\",\"bounceSubType\":\"General\",\"bouncedRecipients\":[{\"emailAddress\":\"jane@example.com\"},{\"emailAddress\":\"richard@example.com\"}],\"timestamp\":\"2016-01-27T14:59:38.000Z\"}",
                  ...
                  expect(Item).toEqual({
                    "content": "{\"reportingMTA\":\"dsn; mta.example.com\",\"bounceType\":\"Permanent\",\"bounceSubType\":\"General\",\"bouncedRecipients\":[{\"emailAddress\":\"recipient@example.com\",\"action\":\"failed\",\"status\":\"5.1.1\",\"diagnosticCode\":\"smtp; 550 5.1.1 user unknown\"}],\"timestamp\":\"2017-08-05T00:41:02.000Z\"}",
              ...
              case 'click':
                expect(Item).toEqual({
                  "content": "{\"ipAddress\":\"192.0.2.1\",\"link\":\"http://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-email-smtp.html\",\"linkTags\":{\"samplekey0\":[\"samplevalue0\"],\"samplekey1\":[\"samplevalue1\"]},\"userAgent\":\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36\",\"timestamp\":\"2017-08-09T23:51:25.000Z\"}",
                  "destination": "[\"recipient@example.com\"]",
                  "eventType": "click",
                  "messageId": "EXAMPLE7c191be45-e9aedb9a-02f9-4d12-a87d-click-configset",
                  "source": "sender@example.com",                  
                  "subject": "Message sent from Amazon SES",
                  "timestamp": "2017-08-09T23:50:05.000Z"
                });
                break;
              case 'complaint':
                if(isNotification){
                  expect(Item).toEqual({
                    content: "{\"complainedRecipients\":[{\"emailAddress\":\"richard@example.com\"}],\"timestamp\":\"2016-01-27T14:59:38.000Z\"}",
                    destination: "[\"jane@example.com\",\"mary@example.com\",\"richard@example.com\"]",
                    eventType: "complaint",
                  ...
                  expect(Item).toEqual({
                    "content": "{\"userAgent\":\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.90 Safari/537.36\",\"complainedRecipients\":[{\"emailAddress\":\"recipient@example.com\"}],\"complaintFeedbackType\":\"abuse\",\"timestamp\":\"2017-08-05T00:41:02.000Z\",\"arrivalDate\":\"2017-08-05T00:41:02.000Z\"}",
                    "destination": "[\"recipient@example.com\"]",
                    "eventType": "complaint",
              ...
              case 'delivery':
                if(isNotification){
                  expect(Item).toEqual({
                    content: "{\"recipients\":[\"jane@example.com\"],\"reportingMTA\":\"a8-70.smtp-out.amazonses.com\",\"smtpResponse\":\"250 ok:  Message 64111812 accepted\",\"timestamp\":\"2016-01-27T14:59:38.000Z\"}",
                  ...
                  expect(Item).toEqual({
                    "content": "{\"recipients\":[\"recipient@example.com\"],\"reportingMTA\":\"mta.example.com\",\"smtpResponse\":\"250 2.6.0 Message received\",\"timestamp\":\"2016-10-19T23:21:04.000Z\"}",
                    "destination": "[\"recipient@example.com\"]",
                    "eventType": "delivery",
                    ...
                    "source": "sender@example.com",
                    "subject": "Message sent from Amazon SES",
                    "timestamp": "2016-10-19T23:20:52.000Z"
                  });
                }
                break;
              case 'deliverydelay':
                expect(Item).toEqual({
                  "content": "{\"delayType\":\"TransientCommunicationFailure\",\"expirationTime\":\"2020-06-16T00:25:40.000Z\",\"delayedRecipients\":[{\"emailAddress\":\"recipient@example.com\",\"status\":\"4.4.1\",\"diagnosticCode\":\"smtp; 421 4.4.1 Unable to connect to remote host\"}],\"timestamp\":\"2020-06-16T00:25:40.000Z\"}",
                  "destination": "[\"recipient@example.com\"]",
              ...
              case 'open':
                expect(Item).toEqual({
                  "content": "{\"ipAddress\":\"192.0.2.1\",\"userAgent\":\"Mozilla/5.0 (iPhone; CPU iPhone OS 10_3_3 like Mac OS X) AppleWebKit/603.3.8 (KHTML, like Gecko) Mobile/14G60\",\"timestamp\":\"2017-08-09T22:00:19.000Z\"}",
                  "destination": "[\"recipient@example.com\"]",
                  "eventType": "open",
                  "messageId": "EXAMPLE7c191be45-e9aedb9a-02f9-4d12-a87d-open-configset",
                  "subject": "Message sent from Amazon SES",
                  "timestamp": "2017-08-09T21:59:49.000Z",
                  "source": "sender@example.com"                  
                });            
                break;
              case 'reject':
